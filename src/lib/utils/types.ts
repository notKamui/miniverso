...
export type Range<Min extends number, Max extends number> = Exclude<Enumerate<Max>, Enumerate<Min>>
...
export type DataFromQueryOptions<
  T extends { initialData?: unknown } | ((...args: never[]) => { initialData?: unknown }),
> = NonNullable<MaybeReturnType<MaybeReturnType<T>['initialData']>>
