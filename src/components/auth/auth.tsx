 ...
 */
export function Auth({ className, view, path, socialLayout, socialPosition }: AuthProps) {
  ...
  switch (currentView) {
    case 'signIn': {
      return (
        <SignIn className={className} socialLayout={socialLayout} socialPosition={socialPosition} />
      )
    }
    case 'signUp': {
      return (
        <SignUp className={className} socialLayout={socialLayout} socialPosition={socialPosition} />
      )
    }
    case 'magicLink': {
      return (
